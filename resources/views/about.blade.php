...
<div class="container-about w-full">
    ...
    <section class="about-company mt-48">
        ...
        <div id="located" class="location mb-24 text-center mt-58 max-lg:mt-40 opacity-0 transform -translate-y-full transition-all duration-1000 ease-out">
